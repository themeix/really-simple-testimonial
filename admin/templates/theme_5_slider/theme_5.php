...
if ($rst_testimonial_themes == 5) {
    ...
    wp_enqueue_script('rst_theme_5_script_1', plugin_dir_url(__FILE__) . 'assets/js/slick.min.js', array('jquery'), time(), true);


    wp_enqueue_style('rst_theme_5_style_1', plugin_dir_url(__FILE__) . 'assets/css/slick.css', array(), time(), 'all');
    wp_enqueue_style('rst_theme_5_style_2', plugin_dir_url(__FILE__) . 'assets/css/rst-style-5.css', array(), time(), 'all');
        ...
        <div class="rst-box-5 rst_<?php echo esc_attr($postid); ?>">
            <div class="rst-container">
                <div class="rst-relative">
                    <div class="rst_slider_<?php echo esc_attr($postid); ?>">
                        ...
                        while ($rst_query_theme_5->have_posts()) {
                            ...
                            <div class="rst-item rst_testimonial_item">
                                <div class="rst-wrap rst-border rst-p-4  rst-rounded-md rst_item_border  rst-transition">
                                    <div class="rst-author-images rst-inline-block rst_author_image">

                                        <?php
                                        if (has_post_thumbnail()) { ?>

                                            <img class="rst-h-15 rst-w-15 rst-rounded-full"
                                ...
                                <div class="rst-css-arrow rst-w-0 rst-h-0 rst-border-solid rst-relative rst-m-auto"></div>
                                <h5 class="rst_author_name">
                                    <?php if (!empty($rst_author_name)) echo $rst_author_name; ?>
                                </h5>
                                <h6 class="rst-author-title">
                    ...
                    <div class="slider-arrows rst-hidden xl:rst-block">
