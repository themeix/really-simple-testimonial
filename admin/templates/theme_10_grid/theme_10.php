...
if ($rst_testimonial_themes == 10) {

    wp_enqueue_style('rst_theme_10_style_1', plugin_dir_url(__FILE__) . 'assets/css/custom.css', array(), time(), 'all');
    wp_enqueue_style('rst_theme_10_style_2', plugin_dir_url(__FILE__) . 'assets/css/tailwind.min.css', array(), time(), 'all');
    ...
    $rst_query_theme_10 = new WP_Query($args);


    if ($rst_query_theme_10->have_posts()) {
        ?>
        ...
        <div class="rst-box-5 rst_<?php echo esc_attr($postid); ?>">
            <div class="rst-container">
                <div class="grid lg:grid-cols-3 sm:grid-cols-2 gap-6">
                    <?php
                    while ($rst_query_theme_10->have_posts()) {
                        $rst_query_theme_10->the_post();
                        ...
                        $rst_socila_link = get_post_meta(get_the_ID(), 'single_repeter_group', true);
                        ...
                        <div class="rst-item p-6 bg-gray-50 rounded-md rst_testimonial_item">
                            ...
                            <div class="rst-author-box flex gap-4 mt-6">
                                ...
                                <div class="flex-col rst-details">
                                    ...
                                    <h6 class="rst-author-title text-base text-coolGray-600  opacity-60">
                                    ...
                                    <p class="rst-date text-sm text-coolGray-600  opacity-60"><?php if (!empty($rst_post_create_date)) echo $rst_post_create_date ?></p>


                                    <div class="rst-social-link mt-3">
                                        <?php

                                        foreach ($rst_socila_link as $item) {

                                            if ($item['title'] == 'facebook') {
                                                ?>
                                                <!--facebook-->
                                                <div class="flex-col !inline-block mr-1">
                                                    <a href="<?php echo $item['tdesc']; ?>" target="_blank"
                                                       tabindex="0">
                                                    ...
                                                    <a href="<?php echo $item['tdesc']; ?>" target="_blank"
                                                       tabindex="0">
                                                        <svg width="16" height="15" viewBox="0 0 16 15" fill="none"
                                                            ...
                                                            <defs>
                                                                <linearGradient id="paint0_linear_41_53" x1="0.457458"
                                                                                y1="7.5"
                                                                                x2="15.4575" y2="7.5"
