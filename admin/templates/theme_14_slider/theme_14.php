...
if ($rst_testimonial_themes == 14) {

    wp_enqueue_script('rst_theme_14_script_1', plugin_dir_url(__FILE__) . 'assets/js/jquery.easing.min.js', array('jquery'), time(), true);
    wp_enqueue_script('rst_theme_14_script_2', plugin_dir_url(__FILE__) . 'assets/js/slick.min.js', array('jquery'), time(), true);
    wp_enqueue_script('rst_theme_14_script_3', plugin_dir_url(__FILE__) . 'assets/js/app.js', array('jquery'), time(), true);


    wp_enqueue_style('rst_theme_14_style_1', plugin_dir_url(__FILE__) . 'assets/css/slick.css', array(), time(), 'all');
    wp_enqueue_style('rst_theme_14_style_2', plugin_dir_url(__FILE__) . 'assets/css/rst-style-9.css', array(), time(), 'all');
    ...
    $rst_query_theme_14 = new WP_Query($args);

    if ($rst_query_theme_14->have_posts()) {
        ?>
        ...
        <div class="container pt-28">
            <div class="rst-box-9 relative">
                <div class="rst-slider">

                    <?php
                    while ($rst_query_theme_14->have_posts()) {
                        $rst_query_theme_14->the_post();
                        ...
                        <div class="rst-item p-6 bg-gray-50 rounded-md">
                            <h6 class="rst-text font-normal text-base text-coolGray-600">
                                <?php if (!empty($rst_content)) {
                                    echo $rst_content;
                                } ?>
                            </h6>
                            <div class="rst-author-box flex mt-4">
                                <div class="flex-col mr-4">
                                    <div class="rst-author-images">
                                        <img class="h-15 w-15 rounded-full" src="<?php echo $rst_author_image2[0]; ?>"
                                             alt="images">
                                    </div>
                                </div>
                                <div class="flex-col">
                                    <h4 class="rst-author-name text-xl font-bold text-coolGray-900 mt-4 md:mt-0">
                                    ...
                                    <div class="rst-author-rating mt-2">
                                        <ul>
