...
wp_enqueue_style('rst_theme_7_style_1', plugin_dir_url(__FILE__) . 'assets/css/custom.css', array(), time(), 'all');
...
$rst_query_theme_7 = new WP_Query($args);


if ($rst_query_theme_7->have_posts()) {
    ?>
    ...
    <div class="rst-box-2 rst_<?php echo esc_attr($postid); ?>">
        <div class="rst-container  rst-pt-20">
            ...
            <div class="sm:rst-grid rst-flex rst-flex-col sm:rst-grid-cols-2  lg:rst-grid-cols-3 rst-gap-6">
                <?php
                while ($rst_query_theme_7->have_posts()) {
                    $rst_query_theme_7->the_post();
                                    ...
                                    for ($i = 1; $i <= 5; $i++) {
                                        if ($i <= $rst_author_rating) {
                                            ...
                                            <svg width="<?php echo $rst_rating_fontsize_option; ?>"
                                                 height="<?php echo $rst_rating_fontsize_option; ?>" viewBox="0 0 17 15" fill="none"
