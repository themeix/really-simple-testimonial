...
if ($rst_query_theme_1->have_posts()) {
    ...
    <div class="rst-style-1 rst_<?php echo esc_attr($postid); ?>">
        <div class="rst-container-1 rst-1-pb-28">
            <div class="rst-style-1-slider">
                <div class="rst-style-1-slide rst_testimonial_item">
                    <div class="slider-for relative rst-1-z-10 rst-1-w-85% md:rst-1-w-92% rst-1-float-right slider_for_<?php echo esc_attr($postid); ?>">
                        <?php
                        while ($rst_query_theme_1->have_posts()) {
                            ...
                            <div class="rst-style-1-box ">
                                <div class="rst-style-1-author-box  rst-1-ml-3 rst-1-pl-4 rst-1-border-l-3  rst-1-border-red-500">
                                    <h4 class="style-1-author-name rst-1-text-2xl rst-1-font-bold rst-1-text-coolGray-900 rst_author_name">
                                        <?php if (!empty($rst_author_name)) echo $rst_author_name; ?>
                                    </h4>
                                    <p class="rst-1-author-title rst-1-text-coolGray-600 rst-1-opacity-50  rst-1-text-base">
                                ...
                                <div class="rst-style-1-rating rst-1-flex rst-1-pl-8 rst-1-mb-4 rst_rating">
                                ...
                                <div class="rst-style-1-text rst-1-pl-8 rst_content">
                                    <p class="rst-1-text-base font-normal rst-1-text-coolGray-600 ">
                    ...
                    <div class="slider-nav slider_nav_<?php echo esc_attr($postid); ?>">
                        <?php
                        while ($rst_query_theme_1->have_posts()) {
                            $rst_query_theme_1->the_post();
                            ?>
                            <div class="thumb-slide">
                                ...
                                if (has_post_thumbnail()) {
                                    echo wp_get_attachment_image(get_post_thumbnail_id(), array('45', '45'), "", array('class' => 'rst_author_image'));
                                } else {
                                    ?>
