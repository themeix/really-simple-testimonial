...
if ($rst_query_theme_1->have_posts()) {
        ...
        ;(function ($) {
            $(document).ready(function () {
                $(".rst_slider_<?php echo esc_attr($postid); ?>").slick({
                    ...
                    fade: true,
                    dots: true,
                    customPaging: function (rst_slider_<?php echo esc_attr($postid); ?>, i) {
                        var thumb = $(rst_slider_<?php echo esc_attr($postid); ?>.$slides[i]).data('thumb');
    ...
    <div class="rst-2-container  pt-24 rst_<?php echo esc_attr($postid); ?>">

        <div class="rst-style-2 rst-2-relative ">
            <div class="slider md:rst-2-w-10/12 rst-2-mx-auto rst-2-text-center rst_slider_<?php echo esc_attr($postid); ?>">
                ...
                while ($rst_query_theme_1->have_posts()) {
                    ...
                    <div data-thumb="<?php echo $rst_author_image2[0]; ?>">
                        <div class="rst-2-items md:rst-2-px-32">
                            <div class="rst-2-author-images rst-2-inline-block rst-2-mb-8 rst_author_image">

                                <?php
                                if (has_post_thumbnail()) {
                                    echo $rst_author_image;
                                } else {
                                    ?>
                            ...
                            <p class="rst-2-text rst-2-text-base rst-2-font-normal rst-2-text-coolGray-600 rst-2-mb-6  rst-2-mx-auto rst_content">
                                <?php if (!empty($rst_content)) {
                                    echo $rst_content;
                                } ?>
                            </p>
                            <h3 class="rst-2-author-name rst-2-text-3xl rst-2-font-bold rst-2-text-coolGray-900 rst_author_name">
                                <?php if (!empty($rst_author_name)) echo $rst_author_name; ?>
                            </h3>
                            <p class="rst-2-author-title rst-2-text-base rst-2-font-normal rst-2-text-coolGray-600 rst-2-mb-2 ">
                            ...
                            <div class="rst-2-author-rating rst-2-flex rst-2-justify-center rst_rating">
