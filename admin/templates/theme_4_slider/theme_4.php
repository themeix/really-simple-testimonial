...
if ($rst_testimonial_themes == 4) {


    wp_enqueue_script('rst_theme_4_script_1', plugin_dir_url(__FILE__) . 'assets/js/slick.min.js', array('jquery'), time(), true);


    wp_enqueue_style('rst_theme_4_style_1', plugin_dir_url(__FILE__) . 'assets/css/slick.css', array(), time(), 'all');
    wp_enqueue_style('rst_theme_4_style_2', plugin_dir_url(__FILE__) . 'assets/css/rst-style-4.css', array(), time(), 'all');
    ...
    $rst_query_theme_4 = new WP_Query($args);


    if ($rst_query_theme_4->have_posts()) {
        ?>
        ...
        <style type="text/css">
            ...
            .rst_slider_prev_<?php echo esc_attr($postid); ?> {
                background-color: <?php echo esc_attr( $rst_nav_bg_color )?> !important;

            }

            .rst_slider_prev_<?php echo esc_attr($postid); ?>:hover {
                background-color: <?php echo esc_attr( $rst_nav_bg_color_hover )?> !important;
            }

            .rst_slider_next_<?php echo esc_attr($postid); ?> {
                background-color: <?php echo esc_attr( $rst_nav_bg_color )?> !important;

            }

            .rst_slider_next_<?php echo esc_attr($postid); ?>:hover {
                background-color: <?php echo esc_attr( $rst_nav_bg_color_hover )?> !important;
            }
        ...
        <div class="rst-container rst_<?php echo esc_attr($postid); ?>">
            <div class="rst-box-4 rst-relative">
                <div class="rst-slider rst_slider_<?php echo esc_attr($postid); ?>">

                    <?php
                    while ($rst_query_theme_4->have_posts()) {
                        $rst_query_theme_4->the_post();
                        ...
                        <div class="rst-style-item    rst-border-5 rst-mt-16 md:md:rst-mt-0 rst-border-coolGray-200  rst-px-10 rst-py-20 rst-rounded-md">
                            <div class="rst-relative rst-author-image rst_author_image ">


                                <?php
                                if (has_post_thumbnail()) { ?>

                                    <img class="rst-h-32.5 rst-w-32.5 rst-rounded-full  rst-absolute rst-bottom-6  rst-border-5 rst-border-coolGray-200"
                            ...
                            <h4 class="rst-author-name rst-text-xl rst-font-bold rst-mt-7 rst_author_name"><?php if (!empty($rst_author_name)) echo $rst_author_name; ?></h4>
                            <p class="rst-author-title rst-font-normal rst-text-base rst-text-coolGray-600 rst-opacity-60">
                            ...
                            <h6 class="rst-autho-text rst-text-base rst-font-normal rst-text-coolGray-600 mt-6 rst_content">
                                <?php if (!empty($rst_content)) {
                                    echo $rst_content;
                                } ?>
                            </h6>
                            <div class="rst-quotes rst-relative">
                  <span class="rst-absolute rst-top-0 rst-right-0"><svg width="58" height="46" viewBox="0 0 58 46"
                                                                        fill="none"
                                                                        xmlns="http://www.w3.org/2000/svg">
                        <path opacity="0.1"
                              d="M53.0794 6.5895C49.012 2.21662 42.8572 0 34.7891 0H31.89V8.10462L34.2208 8.5675C38.1926 9.35525 40.9554 10.9049 42.434 13.179C43.2054 14.4041 43.643 15.8069 43.7038 17.25H34.7891C34.0202 17.25 33.2828 17.5529 32.7391 18.0921C32.1954 18.6312 31.89 19.3625 31.89 20.125V40.25C31.89 43.4211 34.4905 46 37.6882 46H55.0827C55.8516 46 56.589 45.6971 57.1326 45.1579C57.6763 44.6188 57.9818 43.8875 57.9818 43.125V28.75L57.9731 20.3579C57.9992 20.0388 58.55 12.4775 53.0794 6.5895ZM5.79818 46H23.1927C23.9616 46 24.699 45.6971 25.2427 45.1579C25.7864 44.6188 26.0918 43.8875 26.0918 43.125V28.75L26.0831 20.3579C26.1092 20.0388 26.66 12.4775 21.1894 6.5895C17.122 2.21662 10.9673 0 2.89909 0H1.34583e-06V8.10462L2.33087 8.5675C6.30262 9.35525 9.06545 10.9049 10.544 13.179C11.3155 14.4041 11.753 15.8069 11.8138 17.25H2.89909C2.1302 17.25 1.39281 17.5529 0.849122 18.0921C0.305438 18.6312 1.34583e-06 19.3625 1.34583e-06 20.125V40.25C1.34583e-06 43.4211 2.60048 46 5.79818 46Z"
                              fill="#4B5563"/>
                     </svg>
                  </span>
                            </div>
                ...
                <div class="slider-arrows hidden xl:block">
                    <button class="slider-prev rst_slider_prev_<?php echo esc_attr($postid); ?>">
               <span class="!inline-block">
                  <svg width="12" height="21" viewBox="0 0 12 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path
                             d="M11.9813 3.22433L4.83845 10.3672L11.9813 17.51L10.5527 20.3672L0.552734 10.3672L10.5527 0.367188L11.9813 3.22433Z"
                             fill="<?php echo $rst_nav_text_color; ?>"/>
                  </svg>
               </span>
                    </button>
                    <button class="slider-next rst_slider_next_<?php echo esc_attr($postid); ?>">
               <span class="!inline-block">
                  <svg width="12" height="21" viewBox="0 0 12 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                     <path
                             d="M0.0191822 3.22433L7.16204 10.3672L0.0191822 17.51L1.44775 20.3672L11.4478 10.3672L1.44775 0.367188L0.0191822 3.22433Z"
                             fill="<?php echo $rst_nav_text_color; ?>"/>
                  </svg>
               </span>
                    </button>
