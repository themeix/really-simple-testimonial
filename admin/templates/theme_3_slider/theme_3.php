...
if ($rst_testimonial_themes == 3) {


    wp_enqueue_script('rst_theme_3_script_1', plugin_dir_url(__FILE__) . 'assets/js/slick.min.js', array('jquery'), time(), true);


    wp_enqueue_style('rst_theme_3_style_1', plugin_dir_url(__FILE__) . 'assets/css/slick.css', array(), time(), 'all');
    wp_enqueue_style('rst_theme_3_style_2', plugin_dir_url(__FILE__) . 'assets/css/rst-style-3.css', array(), time(), 'all');


    $rst_ratting = plugin_dir_url(__FILE__) . '../icons/rating.svg';
    $rst_ratting_blank = plugin_dir_url(__FILE__) . '../icons/rating-0.svg';
    $rst_ratting_half = plugin_dir_url(__FILE__) . '../icons/ratting-50.svg';
    ...
    $rst_query_theme_3 = new WP_Query($args);


    if ($rst_query_theme_3->have_posts()) {
        ?>

        <script type="text/javascript">
            ;(function ($) {
                $(document).ready(function () {
                    $('.rst_thumbs_slider_<?php echo esc_attr($postid); ?>').slick({
                        slidesToShow: 3,
                        slidesToScroll: 1,
                        asNavFor: '.rst_nav_slider_<?php echo esc_attr($postid); ?>',
                        dots: <?php echo $rst_dots; ?>,
                        arrows: <?php echo $navigation; ?>,
                        prevArrow: $('.rst_prev_3_<?php echo esc_attr($postid); ?>'),
                        nextArrow: $('.rst_next_3_<?php echo esc_attr($postid); ?>'),
                    ...
                    $('.rst_nav_slider_<?php echo esc_attr($postid); ?>').slick({
                        slidesToShow: 1,
                        arrows: false,
                        fade: true,
                        dots: false,
                        ...
                        slidesToScroll: 1,
                        cssEase: 'linear',
                        asNavFor: '.rst_thumbs_slider_<?php echo esc_attr($postid); ?>'
                    });
                });
            }(jQuery));
        </script>
        ...
        <style type="text/css">
            ...
            .rst_<?php echo esc_attr( $postid );?> .slick-dots .slick-active button {
      ...
      if ($navigation == 'true'){ ?>
            ...
            .rst_<?php echo esc_attr( $postid );?> .slider-prev-3:hover {
                background-color: <?php echo esc_attr( $rst_nav_bg_color_hover )?> !important;
            }

            .rst_<?php echo esc_attr( $postid );?> .slider-next-3 {
                background-color: <?php echo esc_attr( $rst_nav_bg_color )?> !important;

            }

            .rst_<?php echo esc_attr( $postid );?> .slider-next-3:hover {
                background-color: <?php echo esc_attr( $rst_nav_bg_color_hover )?> !important;
            }
            ...
            .rst_<?php echo esc_attr( $postid );?> .rst_item_border {
                border-color: <?php echo $rst_item_border_color; ?> !important;

            }


            .rst_<?php echo esc_attr( $postid );?> .rst-css-arrow {
                border-width: 12px 12px 0 12px;
                border-color: <?php echo $rst_item_border_color; ?> transparent transparent transparent !important;
            }
            ...
            .rst_<?php echo esc_attr( $postid );?> .rst_author_image img {
        ...
        <div class="rst-style-3 rst-3-pt-20 rst_<?php echo esc_attr($postid); ?>">
            <div class="rst-3-container">
                <div class="rst-3-relative">
                    <div class="slider-3-box ">
                        <div class="nav-slider-3 rst_nav_slider_<?php echo esc_attr($postid); ?>">
                            <?php
                            while ($rst_query_theme_3->have_posts()) {
                                $rst_query_theme_3->the_post();
                                ...
                                <div class="slider-item rst-3-text-center ">
                                    <p class="rst-3-slider-text rst_content">
                                        <?php if (!empty($rst_content)) {
                                            echo $rst_content;
                                        } ?>
                                    </p>
                                    <h5 class="rst-3-author-name rst-3-text-xl rst-3-font-bold rst-3-text-coolGray-900 rst-3-mt-4 rst_author_name">
                                        <?php if (!empty($rst_author_name)) echo $rst_author_name; ?>
                                    </h5>
                                    <h6 class="rst-3-author-title rst-3-text-base rst-3-text-coolGray-600  rst-3-opacity-60">
                                    ...
                                    <div class="author-rating-3 rst-3-mt-3  rst_ratting_theme_3 rst_rating">
                        ...
                        <div class="thumbs-slider testimonial-style-3-thumbs-slider rst-3-max-w-62.2 rst-3-m-auto rst-3-text-center">
                            <div class="thumbs-slider-3 rst_thumbs_slider_<?php echo esc_attr($postid); ?>">
                                <?php
                                while ($rst_query_theme_3->have_posts()) {
                                    $rst_query_theme_3->the_post();
                                    ...
                                    <div class="thumbs-slider-item">
                                        <div class="avtar-images transition-all  rst-3-relative rst-3-rounded-full rst-3-inline-block rst_author_image">

                                            <?php
                                            if (has_post_thumbnail()) { ?>
                                                <img class="rst-3-w-10 rst-3-h-10 rst-3-rounded-full"
                                                     src="<?php echo $rst_author_image[0]; ?>"
                                                     alt="testimonial">
                                                <?php
                                            } else {
                                                ?>
                                                <img class="w-12.5 h-12.5 cursor-pointer rounded-full"
                                                     src="<?php echo plugin_dir_url(__FILE__) . '../icons/no_image.png'; ?>"
                                                     alt="user">
                                                <?php
                                            }
                                            ?>
                    ...
                    <div class="slider-arrows rst-3-hidden md:rst-3-block">
                        <button class="slider-prev-3 rst-3-group hover:bg-red-700  rst-3-flex rst-3-items-center rst-3-w-[50px] rst-3-h-[50px] rst-3-text-center rst-3-left-[-70px] rst-3-absolute  rst-3-top-[50%] rst-3-translate-y-[-50%] rst-3-justify-center rst-3-bg-yellow-400 rst-3-rounded-full rst-3-duration-300  rst_prev_3_<?php echo esc_attr($postid); ?>">
                  <span class="rst-3-inline-block">
                     <svg width="12" height="21" viewBox="0 0 12 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path
                                d="M11.9552 3.11563L4.81844 10.2585L11.9552 17.4013L10.5279 20.2585L0.536377 10.2585L10.5279 0.258484L11.9552 3.11563Z"
                                fill="<?php echo $rst_nav_text_color; ?>"/>
                     </svg>
                  </span>
                        </button>
                        <button class="slider-next-3 rst-3-group hover:bg-red-700  rst-3-flex rst-3-items-center rst-3-w-[50px] rst-3-h-[50px] rst-3-text-center rst-3-left-[-70px] rst-3-absolute  rst-3-top-[50%] rst-3-translate-y-[-50%] rst-3-justify-center rst-3-bg-yellow-400 rst-3-rounded-full rst-3-duration-300 rst_next_3_<?php echo esc_attr($postid); ?>">
                  <span class="rst-3-inline-block">
                     <svg width="12" height="21" viewBox="0 0 12 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path c
                              d="M0.579209 3.11563L7.71598 10.2585L0.579209 17.4013L2.00656 20.2585L11.998 10.2585L2.00656 0.258484L0.579209 3.11563Z"
                              fill="<?php echo $rst_nav_text_color; ?>"/>
                     </svg>
                  </span>
                        </button>
